      ...
      <div className="w-full overflow-x-auto no-scrollbar py-2 px-6 bg-[#FDFCF8] dark:bg-background-dark mb-4 transition-colors">
        <div className="flex gap-3 min-w-max">
          ...
          <button
            ...
            className="flex h-10 items-center gap-2 justify-center px-6 rounded-full bg-white/5 dark:bg-white/5 text-gray-500 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-white/10 text-sm font-semibold transition-colors"
          >
