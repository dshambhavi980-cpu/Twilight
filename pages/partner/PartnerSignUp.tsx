...
const PartnerSignUp: React.FC = () => {
  ...
  if (verifying) {
    return (
      <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden bg-background-dark font-display transition-colors duration-300">
        <div className="flex items-center bg-transparent p-4 pb-2 justify-between z-10">
          <button onClick={() => setVerifying(false)} className="text-white flex size-12 shrink-0 items-center justify-center cursor-pointer hover:bg-white/5 rounded-full transition-colors">
            ...
            <div className="relative z-10">
              ...
              <form onSubmit={handleVerifyOtp} className="space-y-6">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full rounded-2xl text-white border border-white/10 bg-surface-dark outline-none focus:ring-2 focus:ring-blue-500 h-14 pl-12 pr-4 text-center text-xl tracking-widest placeholder:text-white/30 transition-all font-mono"
                      placeholder="000000"
                      maxLength={8}
                      required
                    />
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full h-14 bg-blue-500 hover:bg-blue-600 disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold rounded-2xl shadow-lg shadow-blue-500/20 transition-all flex items-center justify-center gap-2 group active:scale-[0.98]"
                >
  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden bg-background-dark font-display transition-colors duration-300">
      {/* Header */}
      <div className="flex items-center bg-transparent p-4 pb-2 justify-between z-10">
        <button onClick={() => navigate('/welcome')} className="text-white flex size-12 shrink-0 items-center justify-center cursor-pointer hover:bg-white/5 rounded-full transition-colors">
          <span className="material-symbols-outlined">arrow_back_ios_new</span>
        </button>
        <h2 className="text-white text-lg font-bold flex-1 text-center pr-12">
          Partner Sign Up
      ...
      <div className="flex flex-col flex-1 items-center justify-start px-6 pt-6 pb-8 z-10">
        ...
        <div className="max-w-md w-full text-center mb-10">
          ...
          <p className="text-white/60 text-base font-normal leading-relaxed px-4 text-center">
            Create an account to connect with<br/>your partner and support their journey.
          </p>
        </div>
          ...
          <div className="relative z-10">
            <form className="space-y-5" onSubmit={handleSignup}>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full h-14 bg-blue-500 hover:bg-blue-600 disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold rounded-2xl shadow-lg shadow-blue-500/20 transition-all flex items-center justify-center gap-2 group mt-6 active:scale-[0.98]"
              >
              ...
              <button 
                  onClick={async () => {
                    ...
                    if (isCapacitor) {
                       ...
                       redirectUrl = `${window.location.origin}/#/partner/auth-callback`;
                    }
        ...
        <p className="mt-8 text-center text-white/40 text-sm">
          ...
          <button onClick={() => navigate('/partner/login')} className="text-blue-500 font-bold hover:underline ml-1">
            Log In
          </button>
        </p>
