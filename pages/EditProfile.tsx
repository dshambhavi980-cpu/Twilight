    ...
    <div className="animate-slideIn font-display flex flex-col min-h-screen bg-[#FDFCF8] dark:bg-background-dark transition-colors duration-300 pb-6 relative overflow-x-hidden">
      ...
      <main className="flex-1 px-6 pt-4 flex flex-col items-center">
        ...
        <div className="w-full flex flex-col gap-6">
           ...
           {/* Status */}
           <div className="flex flex-col gap-2">
              <label className="text-xs font-bold text-gray-500 dark:text-gray-400 ml-1 uppercase tracking-wider">Status</label>
              <div className="relative group">
                 <input 
                    type="text"
                    value={status}
                 ...
                 />
                 <span className="material-symbols-outlined absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none">mood</span>
              </div>
           </div>
